...
export default function Home() {
  ...
  return (
    <Layout>
      <h1>Welcome to LLM Benchmark</h1>
      <p>Use the navigation menu to access different sections of the app.</p>
      <button className="btn" onClick={loadMockData}>Load Mock Data into DB</button>
      <button className="btn" onClick={wipeData}>Wipe All Data from DB</button>
    </Layout>
  );
}
