...
- Using mostly "tôi" and "ông" for coversations, but if it's the Buddha speaking then using "ta" instead of "tôi"; "we" or "I" means "mình" when they're used in a thought; "mendicant" means "khất sĩ", "ascetic" means "tu sĩ", "brahmin" means "đạo sĩ", "Realized One" means "Như Lai", "Holy One" means "Thánh Nhân", "Blessed One" means "Thế Tôn", and "Venerable" means "Tôn Giả" while "venerables" often means "chư vị", etc.
