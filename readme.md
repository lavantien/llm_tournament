...
- Features:
  - Be as lightweight and minimal as possible so that it doesn't impact the running LLM. Loading default list of 54 local LLMs (migrated).
...
- **LLM List**: [`llm_list.md`](./llm_list.md) (54 models).

<details>
    <summary>...more</summary>

1. Qwen2.5-Coder-32B-Instruct.i1-Q5_K_M.gguf (23.26 GB)
1. c4ai-command-r-plus-08-2024.i1-IQ1_S.gguf (23.18 GB)
...
1. aya-23-35B.i1-IQ4_XS.gguf (19.20 GB)
...
1. c4ai-command-r-08-2024.i1-IQ4_XS.gguf (17.83)
...
1. gemma-2-27b-it.IQ4_XS.gguf (14.81 GB)
1. TowerInstruct-13B-v0.1.Q8_0.gguf (13.83 GB)
1. vicuna-13b-v1.5-16k-Q8_0.gguf (13.83 GB)
1. YiffyEstopianMaid-13B.Q8_0.gguf (13.83 GB)
1. Mistral-Nemo-12B-ArliAI-RPMax-v1.3.Q8_0.gguf (13.02 GB)
...
1. Yi-Coder-9B-Chat-Q8_0.gguf (9.38 GB)
...
1. Phi-3.5-mini-instruct.i1-IQ4_XS.gguf (2.06 GB)
...
- SQLite 3.47+.
- Docker/Compose.
- TabbyAPI/SillyTaverns, LM Studio/AnythingLLM, Aphrodite, LlamaCPP/KoboldCPP, Ollama/Open Web UI.
...
- **Parameters**: (with LM Studio) all LLMs should be set to
  ...
  - 512 batch size,
  - full GPU offload if possible, or else (\> 6gb), fine tune for fitting entirely in 9.5gb dedicated VRAM,
