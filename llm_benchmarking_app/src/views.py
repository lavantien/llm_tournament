from PyQt6.QtWidgets import QMainWindow, QTabWidget, QVBoxLayout, QWidget, QListWidget, QPushButton, QHBoxLayout, QFormLayout, QLineEdit, QTableWidget, QBarCategoryAxis, QValueAxis, QTableWidgetItem
from PyQt6.QtCharts import QChartView, QBarSeries, QBarSet, QChart
