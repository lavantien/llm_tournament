from PyQt6.QtWidgets import QMainWindow, QTabWidget, QVBoxLayout, QWidget, QListWidget, QPushButton, QHBoxLayout, QFormLayout, QLineEdit, QTableWidget, QBarSeries, QBarSet, QBarCategoryAxis, QValueAxis, QTableWidgetItem
