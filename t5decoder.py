...
class TranslatorApp:
    ...
    def setup_ui(self):
        ...
        self.browse_button = ttk.Button(path_frame, text="Browse", command=self.browse_model)
        self.browse_button.pack(side=tk.LEFT)
        
        self.load_button = ttk.Button(path_frame, text="Load Model", command=self.load_model)
        ...
        self.status_text.configure(state='disabled')  # Make it read-only by default
