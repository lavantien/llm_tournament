# Senior Software Engineer Technical Handbook

## Authors

**Purpose**: Skim through this doc 1 week or 1 day before the interview, to refresh memory.
**Human Composer**: `лавантиен`, <https://github.com/lavantien>
**Agent Master 1**: `Qwen2.5-Coder-7B-Instruct-Q8_0.gguf`, _32k context_, 0.8 temp, 54 tok/s, 3080 10g, `llama.cpp/LM Studio`.
**Agent Master 2**: `Qwen2.5-Coder-14B-Instruct-Q8_0.gguf`, _32k context_, 0.8 temp, 1.5 tok/s, 3080 10g, `llama.cpp/LM Studio`.
**Agent Slave 1**: `llama-3.2-3b-instruct-q8_0.gguf`, _128k context_, 0.8 temp, 56 tok/s, 3080 10g, `llama.cpp/LM Studio`.
**Agent Slave 2**: `ChatGPT 4o Free`, _8k context_, 156 tok/s, vendor app.
**Agent Slave 3**: `Claude 3.5 Haiku Free`, _25k context_, 63 tok/s, vendor app.
**Prompts**: [my gists](https://gist.github.com/lavantien/958393262996194c9c0ad2540cb8e58a).

---

## Preface

Welcome to the "SWE L5 Technical Guide," an in-depth resource meticulously crafted for software engineers aiming to excel in advanced Go programming and build robust systems. This comprehensive manual is designed to equip you with the knowledge, skills, and tools required to tackle complex challenges in modern software development.

### About This Book

The "SWE L5 Technical Guide" serves as your go-to companion as you navigate through intermediate to advanced levels of software engineering using Go. It is structured around a variety of topics, from foundational concepts of Go programming to advanced systems design and implementation techniques. The book covers essential libraries, patterns, and architectures while emphasizing practical application in real-world scenarios.

### Tech Stack Overview

This guide focuses on the following technologies:
...
- **Patterns**: Event-driven, CQRS, Saga, RBAC, Dependency Injection, Domain-Driven Design (DDD).

### Architecture and System Design

The guide emphasizes the following architectural principles:

- **Monorepo with Microservices**: Organizing codebases for scalability and collaboration.
- **Server-Side Rendering**: Enhancing user experience with dynamic content generation on the server side.
- **Single-Machine Environment Focus**: Focusing on localhost environments for development and testing.

### Key Features

Key features that set this guide apart include:

- **ACID Transactions**: Ensuring data integrity in concurrent systems.
- **Caching Strategies**: Implementing efficient caching mechanisms with invalidation strategies.
- **Graceful Shutdowns**: Designing applications to handle shutdowns gracefully without data loss.
- **Fault Tolerance**: Building systems resilient to failures and errors.
- **Rate Limiting**: Controlling the rate of requests to protect resources.

### Testing Emphasis

A significant portion of this guide is dedicated to testing:

- **90%+ Unit Test Coverage**: Ensuring high code quality through thorough unit tests.
- **End-to-End Testing**: Verifying system functionality from start to finish.

### Domain Focus: P2P Exchange Systems

The practical application section of the book centers around building a P2P exchange system, covering:

- **Payment Integration**: Handling financial transactions within the platform.
- **Notifications**: Real-time communication with users.
- **Backoffice Features**: Administrative interfaces for monitoring and managing the system.
- **Reporting**: Generating insights and analytics from transaction data.

### Who This Book Is For

This guide is tailored for software engineers who are:

- Proficient in Go or seeking to learn it.
- Interested in building scalable, robust, and maintainable systems using modern technologies.
- Committed to continuous learning and applying best practices in their work.

### How to Use This Book

The book is organized into sections that build upon each other. We recommend starting with foundational concepts and gradually moving towards more advanced topics. Each chapter includes practical examples, exercises, and references to further resources.

We hope you find this guide valuable as you advance your skills in software engineering. Let's embark on this journey together and master the art of building high-quality systems using Go!
